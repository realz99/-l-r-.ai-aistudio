...
import { Search, Plus, Bell, Calendar as CalendarIcon, ExternalLink, ChevronDown, Video, WifiOff, MapPin, Clock, Hash, Users, Menu, X, Mic, CloudUpload, FolderPlus, MessageSquare, CheckSquare, ChevronLeft, ChevronRight } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ transcripts, onSelectTranscript, view = 'conversations', channelId, onToggleSidebar, onRecord, onOpenModal }) => {
  ...
  const handleConnectCalendar = async () => {
      try {
          await triggerGoogleLogin(); // Re-auth to ensure scopes
          ...
          {!isSearchOpen && (
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                    ...
                    {/* Full Creation Menu - Expanded as Requested */}
                    {showAddMenu && (
                        <>
        ...
        {activeTab === 'conversations' ? (
            ...
            <div className="py-4 space-y-4">
                ...
                {!isCalendarLoading && calendarEvents.length > 0 ? (
                    <div className="bg-[#121212]/90 rounded-2xl p-4 border border-white/10">
                        {/* Calendar Header */}
